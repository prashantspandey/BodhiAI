...
def home(request):
    ...
    if user.is_authenticated:
        ...
        if user.is_staff:
            ...
            sheet_links = \
                    ['1.csv','2.csv','3.csv','4.csv','5.csv','6.csv','8.csv','9.csv','10.csv','11.csv','13.csv','14.csv','15.csv','16.csv','17.csv','18.csv','20.csv']
            #sheet_links2 = \
            #        ['statement_ry.csv']
            #adding_quest =\
            #delete_allQuestions.delay("JEN")
            sch = School.objects.get(name='JEN')
            allquestions_institute.delay('Quatitative-Analysis',sch)
